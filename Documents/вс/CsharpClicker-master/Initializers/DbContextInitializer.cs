...
public static class DbContextInitializer
{
    ...
    public static void InitializeDbContext(AppDbContext appDbContext)
    {
        ...
        const string Boost1 = "Кисточка";
        const string Boost2 = "Кофеёк";
        const string Boost3 = "Аутсорс-художник";
        const string Boost4 = "Подушка-лягушка";
        const string Boost5 = "Pigcasso";
        ...
        void AddBoostIfNotExist(string name, long price, long profit, bool isAuto = false)
        {
            ...
            if (!existingBoosts.Any(eb => eb.Title == name))
            {
                ...
                var pathToImage = Path.Combine(".", "Resources", "myBoosts", $"{name}.png");
